...
from growatt_monitor.utils.regex_helper import _lazy_re_compile
...
if not PY310:
    raise WrongPyVersion("🐍 This script requires Python 3.10+")
...
def get_complete_version(version=None):
    ...
    """
    if version is None:
        from growatt_monitor import VERSION as version
    else:
